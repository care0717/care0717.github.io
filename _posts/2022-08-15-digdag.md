...
## Digdag用語
Digdagの概要は[いろんな良い記事](https://qiita.com/hiroysato/items/d0fe5e2d88c267413a82)があるのでそこを参照していただきたい。この記事内で用いるDigdagの用語を解説しておく。(実質http://docs.digdag.io/concepts.html の翻訳)
