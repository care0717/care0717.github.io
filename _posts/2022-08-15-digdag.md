...
## Digdag用語
Digdagの概要は[いろんな良い記事](https://qiita.com/hiroysato/items/d0fe5e2d88c267413a82)があるのでそこを参照していただきたい。ただ実質http://docs.digdag.io/concepts.html の翻訳になりそうだが、Digdagの用語等の解説はしておく。
